...
import sty from "./PlasmicPriceCard.module.css"; // plasmic-import: J18I9nWhk_2o/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__bBxeh)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__dtca)}>
          <div className={classNames(projectcss.all, sty.freeBox__sxnWu)}>
            {renderPlasmicSlot({
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___7TYqt)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__qIc1B)}>
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__d8VtQ)}>
              {renderPlasmicSlot({
                defaultContents: "8",
                value: args.dollars,
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__la2Xo)}
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__lSmhu)}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp__l3USq)}
                  description={
                    "Vestibulum mollis odio dictum ultrices facilisis molestie vestibulum"
                  }
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg___4JstF)}
                      role={"img"}
                    />
                  }
                />
                ...
                <ValueProp
                  className={classNames(
                    "__wab_instance",
                    sty.valueProp___5FbNy
                  )}
                  description={"Mus consequat a justo"}
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg__unf1M)}
                      role={"img"}
                    />
                  }
                />
            ...
            label={
              <div
                className={classNames(
                  ...
                  sty.text___5Fy1I,
                  {
                    [sty.textprimary___5Fy1IrTjFe]: hasVariant(
                      $state,
                      "primary",
                      "primary"
                    )
