...
import Label from "../../Label"; // plasmic-import: nApxcTq4AhjM/component
import TextInput from "../../TextInput"; // plasmic-import: VeAGvXsgutNN/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: cyd7blQUYuej/component
import Description from "../../Description"; // plasmic-import: kKCvQJl9CTtt/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: 21yfH8a5FQ3G5YYAEZCSx/projectcss
import sty from "./PlasmicTextField.module.css"; // plasmic-import: oF4Rxlvj3gfP/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___0EmI, {
          [sty.freeBoxiconEnd___0EmIHzDpy]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___0EmI8Dezo]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___0EmIo9Kpk]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__i7Sdn, {
            [sty.freeBoxiconStart__i7Sdn8Dezo]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__i7Sdno9Kpk]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__hfTUh)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__hp35U, {
            [sty.freeBoxiconEnd__hp35UHzDpy]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__hp35U8Dezo]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__yaYJy)}
                role={"img"}
              />
            ),
