...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: pQtSbsuJwgZQ/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__jof7E)}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__yUaud)}
      >
        <PlasmicImg__
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__hc5Ki)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__ivR5N)}>
            {renderPlasmicSlot({
