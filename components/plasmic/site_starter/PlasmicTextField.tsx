...
import Label from "../../Label"; // plasmic-import: vl9XbccceF56/component
import TextInput from "../../TextInput"; // plasmic-import: TeGVCbMPC6RJ/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: Xm7UR50DygxN/component
import Description from "../../Description"; // plasmic-import: 6MXgJQW6SBNi/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: 4u1ey5YPrV7Q3hoMkXvHtk/projectcss
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 5iSrCw3WLUgl/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__q1Msx, {
          [sty.freeBoxiconEnd__q1MsXki8W]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__q1MsXi6Uzz]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__q1MsXx7EKb]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__xqkn1, {
            [sty.freeBoxiconStart__xqkn1I6Uzz]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__xqkn1X7EKb]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__oS03O)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___0DJK, {
            [sty.freeBoxiconEnd___0DJKki8W]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___0DJKi6Uzz]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__zOQj)}
                role={"img"}
              />
            ),
