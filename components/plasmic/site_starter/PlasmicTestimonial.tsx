...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: Gvk4Xr31D9gt/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__v8F3J)}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__k3Lyg)}
      >
        <PlasmicImg__
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__qnDr6)}
        >
          <div className={classNames(projectcss.all, sty.freeBox___8GAtX)}>
            {renderPlasmicSlot({
