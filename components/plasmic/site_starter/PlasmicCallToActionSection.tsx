...
import sty from "./PlasmicCallToActionSection.module.css"; // plasmic-import: fByrK_z8GwQo/css
...
function PlasmicCallToActionSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__kWsr8)}>
        <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox__fSyWj)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__hpcJk)}
          >
            <Stack__
              as={"div"}
                ...
                defaultContents: (
                  <React.Fragment>
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__vL87K)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
